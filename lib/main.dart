...
void main() async {
  ...
  AudioManager.instance.setSfxEnabled(SettingsService.instance.soundEnabled);
  ...
  void _tapLane(int lane) {
    ...
    if (nearestNote != null) {
      ...
      setState(() {
        combo = 0;
        if (SettingsService.instance.soundEnabled) {
          AudioManager.instance.playSfx(SoundEffect.fail);
        }
      });
    }
  }
